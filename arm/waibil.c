...
#include <malloc.h>
 ...
 int main (void)
 {
   ...
   const int R = 6371000  ;  // радиус земли
   int n;                // частоты измерений
   n =(int) sqrt((x1-x0)*R*M_PI/180*(x1-x0)*R*M_PI/180+(y1-y0)*R*M_PI/180*cos((double)(x0/180*M_PI))(y1-y0)*R*M_PI/180*cos((double)(x0/180*M_PI)))*2;
